...
如果你也想出一份力，可以点开“chinese-汉化中.json”文件，然后点击右上角的铅笔图标进行编辑，对于你觉得翻译不准确的地方进行修改。可以按ctrl+F进行关键字查找，左边是原始字符，右边是翻译汉化。修改完后点击右上角的绿色按钮：commit changes进行提交，我会审核通过后就可以让你的翻译出现在文件中。
